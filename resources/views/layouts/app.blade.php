        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Quick Search -->
                    <form method="GET" action="{{ route('search.index') }}" class="hidden lg:block">
                        <div class="relative">
                            <input type="text" name="q" placeholder="Search everything..." class="input-field w-64 pl-10 py-2 text-sm" value="{{ request('q') }}">
