...
<div class="container mx-auto px-4 py-8">
    ...
    <section class="mb-16">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-3xl font-bold text-white">Recently Added</h2>
            <a href="{{ route('media.index', ['sort' => 'latest']) }}" class="text-accent-400 hover:text-accent-300 text-sm font-medium transition-colors">
                View All →
            </a>
        </div>
