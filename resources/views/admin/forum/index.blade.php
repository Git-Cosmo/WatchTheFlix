...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.forum.create') }}" class="btn-primary">Add New Category</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-b border-dark-700">
                    ...
                    <td class="p-4 text-right space-x-2">
                        ...
                        <a href="{{ route('admin.forum.edit', $category) }}" class="text-accent-500 hover:text-accent-400">Edit</a>
                        <form method="POST" action="{{ route('admin.forum.destroy', $category) }}" class="inline">
                            @csrf
                            @method('DELETE')
