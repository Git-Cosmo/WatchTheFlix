...
<div class="max-w-3xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white">Edit Forum Category</h1>
        <p class="text-dark-400 mt-1">Update category details and settings</p>
    </div>

    <!-- Form Card -->
    <div class="card">
        <form method="POST" action="{{ route('admin.forum.admin.update', $category) }}" class="p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                          ...
                          placeholder="Brief description of what this category is for...">{{ old('description', $category->description) }}</textarea>
