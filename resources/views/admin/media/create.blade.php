...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold mb-8">Add New Media</h1>

        <form method="POST" action="{{ route('admin.media.store') }}" class="card p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type" id="type" required class="input-field w-full">
                        ...
                        <option value="episode" {{ old('type') == 'episode' ? 'selected' : '' }}>Episode</option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="url" name="backdrop_url" id="backdrop_url" value="{{ old('backdrop_url') }}" 
                           class="input-field w-full" placeholder="https://...">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="imdb_rating" id="imdb_rating" value="{{ old('imdb_rating') }}" 
            ...
            <div class="flex items-center space-x-6">
                <label class="flex items-center">
                    <input type="checkbox" name="requires_real_debrid" value="1" 
                           {{ old('requires_real_debrid') ? 'checked' : '' }}
