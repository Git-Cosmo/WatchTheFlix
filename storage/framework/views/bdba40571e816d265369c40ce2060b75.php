    ...
    <div class="container mx-auto px-4 py-16 relative z-10">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="<?php echo e(route('register')); ?>" class="btn-primary glow-accent inline-flex items-center justify-center">
                    Get Started
...
<div class="container mx-auto px-4 py-8">
    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="<?php echo e(route('media.show', $item)); ?>" class="group card overflow-hidden hover:border-accent-500 transition-all hover:glow-accent">
                <div class="relative overflow-hidden">
                    <?php if($item->poster_url): ?>
                    <img src="<?php echo e($item->poster_url); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-105">
                    <?php else: ?>
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold mb-2 text-white group-hover:text-accent-400 transition-colors"><?php echo e($item->title); ?></h3>
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <span class="text-sm font-medium text-white"><?php echo e($item->imdb_rating); ?>/10</span>
                    </div>
                    <?php endif; ?>
                </div>
            </a>
    ...
    <section>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <a href="<?php echo e(route('media.show', $item)); ?>" class="group card overflow-hidden hover:border-accent-500 transition-all">
                <div class="relative overflow-hidden">
                    <?php if($item->poster_url): ?>
                    <img src="<?php echo e($item->poster_url); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105">
                    <?php else: ?>
                ...
                <div class="p-2">
                    ...
                    <p class="text-xs text-gh-text-muted"><?php echo e($item->release_year); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
