    ...
    <div class="container mx-auto px-4 py-20 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register')); ?>" class="btn-primary px-8 py-4 text-lg glow-accent inline-flex items-center justify-center font-semibold">
                    Get Started
                    <svg class="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                </a>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary px-8 py-4 text-lg font-semibold">Sign In</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
