    ...
    <div class="container mx-auto px-4 py-24 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-300">
                <a href="<?php echo e(route('register')); ?>" class="btn-primary px-8 py-4 text-lg glow-accent inline-flex items-center justify-center font-semibold transform hover:scale-105 transition-all">
                    Get Started
                    <svg class="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                </a>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary px-8 py-4 text-lg font-semibold transform hover:scale-105 transition-all">Sign In</a>
            </div>
            <?php else: ?>
            <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-300">
                <a href="<?php echo e(route('media.index')); ?>" class="btn-primary px-8 py-4 text-lg glow-accent inline-flex items-center justify-center font-semibold transform hover:scale-105 transition-all">
                    Browse Content
                    <svg class="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" />
                    </svg>
                </a>
                <a href="<?php echo e(route('tv-guide.index')); ?>" class="btn-secondary px-8 py-4 text-lg font-semibold transform hover:scale-105 transition-all inline-flex items-center justify-center">
                    TV Guide
                    <svg class="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="container mx-auto px-4 py-8">
    ...
    <section class="mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <a href="<?php echo e(route('media.show', $item)); ?>" class="group">
                <div class="card overflow-hidden hover:border-accent-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-accent-500/10">
                    <div class="relative overflow-hidden aspect-[2/3]">
                        ...
                        <img src="<?php echo e($item->poster_url); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        <?php else: ?>
                        ...
                        <div class="absolute top-3 right-3 flex items-center gap-1 px-2 py-1 bg-black/70 backdrop-blur-sm rounded-md">
                            ...
                            <span class="text-sm font-semibold text-white"><?php echo e($item->imdb_rating); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <div class="p-4">
                        <h3 class="text-base font-semibold mb-1 text-white group-hover:text-accent-400 transition-colors line-clamp-1"><?php echo e($item->title); ?></h3>
                        <p class="text-sm text-gh-text-muted"><?php echo e($item->release_year); ?> • <?php echo e(ucfirst($item->type)); ?></p>
                    </div>
                </div>
            </a>
        ...
        <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
            ...
            <a href="<?php echo e(route('media.show', $item)); ?>" class="group">
                <div class="card overflow-hidden hover:border-accent-500/50 transition-all duration-300">
                    ...
                    <div class="p-3">
                        <h3 class="text-sm font-semibold truncate text-white group-hover:text-accent-400 transition-colors"><?php echo e($item->title); ?></h3>
                        <p class="text-xs text-gh-text-muted mt-0.5"><?php echo e($item->release_year); ?></p>
                    </div>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
