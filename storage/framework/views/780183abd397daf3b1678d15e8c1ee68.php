        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold bg-gradient-to-r from-accent-400 to-accent-600 bg-clip-text text-transparent hover:from-accent-300 hover:to-accent-500 transition-all">
                        WatchTheFlix
                    </a>
                ...
                <div class="flex items-center space-x-4">
                        ...
                        <div id="notifications-menu" class="hidden absolute right-0 mt-2 w-80 bg-dark-800 border border-dark-700 rounded-lg shadow-lg z-10 max-h-96 overflow-y-auto">
                            <div class="p-4 border-b border-dark-700">
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                                    <form method="POST" action="<?php echo e(route('notifications.mark-all-read')); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="p-4 border-b border-dark-700 <?php echo e($notification->read_at ? 'bg-dark-800' : 'bg-dark-750'); ?> hover:bg-dark-700 transition-colors">
                                <div class="flex items-start space-x-3">
                                    <div class="flex-shrink-0">
                                        <?php if($notification->type === 'App\Notifications\WelcomeNotification' || str_contains($notification->type, 'Welcome')): ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm text-dark-100"><?php echo e($notification->data['message'] ?? 'New notification'); ?></p>
                                        <p class="text-xs text-dark-400 mt-1"><?php echo e($notification->created_at->diffForHumans()); ?></p>
                                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div id="user-menu" class="hidden absolute right-0 mt-2 w-48 bg-dark-800 border border-dark-700 rounded-lg shadow-lg z-10">
                            ...
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2 text-sm text-dark-300 hover:bg-dark-700 hover:text-dark-100 border-t border-dark-700">
                                <svg class="h-4 w-4 mr-1.5 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            ...
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" class="block border-t border-dark-700">
                                <?php echo csrf_field(); ?>
